...
int main()
{
    ...
    std::cout << "qs: " << ik->xToQs(0.2, 0.2) << std::endl;
    ...
    //     //     count = 0;
    //     // }
    //     client.setFT({0, 100, 0, 0, 0, 0});
    //     client.printSensorInfo();
    //     // client.step();
    //     count++;
    //     client.render();
    //     glfwPollEvents();
    ...
    //     // std::cout << "ik solve time: " << ompl::time::seconds(ompl::time::now() - start_time) << " seconds" << std::endl;
    //     sleep(1);
    // }
